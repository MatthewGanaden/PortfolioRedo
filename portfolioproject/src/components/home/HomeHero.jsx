        ...
        <div class="relative">
            <div class="flex flex-col gap-8 box-border mx-11 my-6 px-14 rounded-3xl bg-neutral-900 relative z-50 h-[calc(100vh-3rem)]">
                <div class="flex justify-between items-center pt-6">
                    <Navbar fluid rounded class="w-full">
                        <NavbarBrand href="https://flowbite-react.com">
                            <img src="/logo.png" className="mr-3 h-6 sm:h-9" alt="MJGanaden Logo" />
                        </NavbarBrand>
                        ...
                        <NavbarCollapse class="bg-white ">
                            <NavbarLink href="#" class="text-sky-600" active>
                            Home
                            </NavbarLink>
                            <NavbarLink href="#" class="transition-all duration-300 ease-in-out hover:text-sky-600">Projects</NavbarLink>
